...
export default function DropDown({
  ...
  return (
    <Popover open={menuOpen} onOpenChange={handleMenuStateChange}>
      ...
      <PopoverContent className="w-[--radix-popover-trigger-width] max-h-[--radix-popover-content-available-height] bg-white shadow-lg ring-1 ring-black ring-opacity-5">
